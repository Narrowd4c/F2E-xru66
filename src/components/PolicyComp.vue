...
<template>
  <div class="container">
    ...
    <div class="policy position-relative">
      <swiper-container class="" ref="swiperPolicy" init="false">
        <swiper-slide class="d-flex align-items-center" v-for="i in 2" :key="i">
          <div class="row policy-card">
            <img class="col-7 p-0 pe-6 policy-card-img" src="@/assets/images/policy2.png" alt="" />
            <div class="col-5 p-0 ps-6 align-self-start">
              <h3 class="policy-card-title fw-bold">為毛孩子謀福利！推動寵物醫療保障方案</h3>
              <ol class="policy-card-content">
                <li>
                  <p>
                    街上氣氛真設立寵物醫療基金：每年撥款新台幣 10
                    億元，專款專用於支援家庭寵物的醫療費用
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    合作動物醫院：目前已有和超過 200
                    家動物醫院進行初步的合作討論的很棒，從小孩到大人，甚至有些狗狗朋友都帶著貓耳來找我握手，真的太可愛了！這次的活動不僅讓我看到大家的熱情，更加堅定了我推進「貓咪友善環境」政策的決心。
                  </p>
                </li>
              </ol>
            </div>
